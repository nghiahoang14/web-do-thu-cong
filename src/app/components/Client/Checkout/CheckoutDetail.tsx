...
export const CheckoutDetail = () => {
  ...
  <div className="px-4 sm:px-10 py-6">
    ...
    <div className="border p-4 grid grid-cols-1 sm:grid-cols-2 gap-4 border-[#ddd] rounded mt-[30px]">
      <div>
    ...
    {/* Responsive buttons */}
    <div className="flex flex-col sm:flex-row items-center justify-center my-[40px] gap-[20px]">
      <Link
        href="/Client"
        className="w-full sm:w-auto text-center border border-black text-black py-2 px-4 rounded hover:bg-gray-100 transition"
      >
        Tiếp tục mua hàng
      </Link>
      ...
      <Link
        ...
        className="w-full sm:w-auto text-center bg-red-600 hover:bg-red-700 text-white py-2 px-4 rounded font-medium transition"
      >
        Lịch sử mua hàng
      </Link>
    </div>
